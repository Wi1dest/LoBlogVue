      ...
      <div class="contact-btn-group">
        <el-dropdown>
          <span class="el-dropdown-link">
            <i class="el-icon-chat-dot-round" style="margin-right: 2px" @click.stop="toggleDropdown"></i><span style="color: blue; text-decoration: underline;">WeChat  </span>
          </span>
          <el-dropdown-menu slot="dropdown" >
            <img src="/../wechat.webp" class="qrcode" alt="微信二维码" >
          </el-dropdown-menu>
        </el-dropdown>

        <!-- Github联系按钮 -->
        <a class="contact-btn" href="https://github.com/Wi1dest" target="_blank">
          <i class="el-icon-user-solid" style="margin-right: 2px"></i><span style="color: blue;">Github  </span>
        </a>

        <!-- Gitee联系按钮 -->
        <a class="contact-btn" href="https://gitee.com/wi1dest" target="_blank">
          <i class="el-icon-user" style="margin-right: 2px"></i><span style="color: blue;">Gitee</span>
        </a>
      </div>
      <a class="collection-btn" href="mailto:loshungan@outlook.com">
        <i class="el-icon-star-off" style="margin-right: 2px"></i>发邮件给我
      </a>
    </div>
...
<style scoped>
  .qrcode {
    width: 100%; /* 使图片宽度占满容器 */
    max-width: 200px; /* 最大宽度为200px（可根据需要调整） */
    height: auto; /* 高度自适应 */
  ...
  @media (max-width: 768px) {
    .qrcode {
      max-width: 150px; /* 在小屏幕上，最大宽度调整为150px */
    }
  }
  .card-content1 {
