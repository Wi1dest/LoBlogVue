          ...
          <ul class="scroll-menu">
            ...
            <li>
              <el-dropdown placement="bottom">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item @click.native="$router.push({path: '/admin'})" v-if="$store.state.currentUser && $store.state.currentUser.id === 1">
                  <i class="fa fa-dashboard" aria-hidden="true"></i> <span>进入后台</span>
                </el-dropdown-item>
...
<!-- 
          ...
          <template v-else>
            ...
            <li @click="smallMenu({path: '/admin'})"  v-if="$store.state.currentUser && $store.state.currentUser.id === 1">
              <div>
                <i class="fa fa-user-circle" aria-hidden="true"></i>
                <span>&nbsp;进入后台</span>
              </div>
